...
# Adaped from the crosstool-ng project, specifically
# https://github.com/crosstool-ng/crosstool-ng/blob/master/scripts/xldd.in
# as of commit 99766112168ba6677c5f4a7719bde21d59e48573
#
# Licensed under GPLv2 as per CROSSTOOL-NG-LICENSE
